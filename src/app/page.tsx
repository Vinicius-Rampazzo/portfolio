  ...
  const projects: Project[] = [
    {
      ...
      description:
        "Projeto que me levou ao primeiro lugar no Hackathon 2025 da ImobiBrasil, onde criei a Lois - uma IA integrada a chatbot com filtro inteligente que facilita a busca por imóveis através de conversas naturais, transformando a experiência no mercado imobiliário.",
    ...
    },
    {
      title: "Tech Informe",
      description:
        "Blog criado para compartilhar conhecimento através de artigos baseados em meus projetos e estudos sobre tecnologia, com a possibilidade de outros autores hospedarem e compartilharem seus artigos de forma organizada.",
    ...
    },
    {
      title: "Pixel Art",
      description:
        "Meu primeiro projeto desenvolvido na Trybe utilizando HTML, CSS e JavaScript, focado em aprimorar os fundamentos e treinar a lógica de programação. Um projeto especial que marca o ponto de partida de toda essa jornada, o início de tudo.",
  ...
  const experiences: Experience[] = [
    {
      ...
      description:
        "Sou líder do setor de hospedagem de e-mails corporativos, arquitetando soluções escaláveis, automações e desenvolvimento em um dos maiores CRMs imobiliários do Brasil.",
    },
    {
      ...
      period: "2023",
      description:
        "Pude aprender muito sobre redes e desenvolvimento de software, trabalhando em equipe e contribuindo para o crecimento da empresa com os demais colaboradores.",
    },
    {
      company: "Trybe",
      ...
      period: "2022",
      description:
        "Formado pela Trybe em 2022 através de uma jornada intensa de desafios e diversos projetos práticos que consolidaram minha base em programação.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-800 to-green-900 text-white">
      ...
      >
        ...
        >
          ...
          <p className="text-lg md:text-2xl mb-8 text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Desenvolvedor{" "}
            <span className="text-emerald-400 font-semibold">Full Stack</span>{" "}
            apaixonado em tecnologia e segurança! Compartilho experiências
            digitais para{" "}
            <span className="text-emerald-400 font-semibold">conectar</span>{" "}
            pessoas.
          </p>
          ...
          <div className="flex gap-6 justify-center mb-12">
            <a
              ...
              className="p-3 bg-white/10 hover:bg-emerald-500/20 rounded-full backdrop-blur-sm transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-emerald-500/25"
            >
          ...
          <button
            className="group bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-500 hover:to-green-500 px-8 py-4 rounded-full font-semibold transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-emerald-500/30"
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                  ...
                  inovação. Há anos mergulhado neste universo, transformando
                  ideias em interfaces elegantes e soluções funcionais que
                  realmente fazem a diferença.
                </p>
                <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                  Formado pela Trybe em programação, estou expandindo ainda mais
                  meus horizontes: ao final de 2025, me formo em Defesa
                  Cibernética através da FIAP. Porque acredito que não basta
                  apenas criar, mas sim proteger cada linha de código
                  construído.
                </p>
                <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                  É essa a visão que tenho, do desenvolvimento à segurança, que
                  me move a entregar soluções web modernas, escaláveis e, acima
                  de tudo, seguras.
                </p>
              ...
              <div
                className={`space-y-6 transform transition-all duration-800 delay-500 ${
                  visibleSections.about
                    ? "translate-x-0 opacity-100"
                    : "translate-x-8 opacity-0"
                }`}
      ...
      >
        <div className="container mx-auto px-6">
          <h2
            className={`text-4xl font-bold mb-16 text-center bg-gradient-to-r from-emerald-400 to-green-500 bg-clip-text text-transparent transform transition-all duration-800 ${
                ...
                >
                  ...
                  <div className="ml-16 bg-slate-800/50 backdrop-blur-sm border border-emerald-500/20 rounded-xl p-6 flex-1 hover:bg-slate-800/70 hover:border-emerald-400/40 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/10">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                      ...
                      <span className="text-sm text-gray-400 bg-emerald-500/10 border border-emerald-500/20 px-3 py-1 rounded-full backdrop-blur-sm">
                        {exp.period}
                      </span>
                    </div>
      ...
      >
        <div
          className={`container mx-auto px-6 text-center transform transition-all duration-800 ${
      ...
      <footer className="py-8 border-t border-emerald-500/20 bg-black/30 backdrop-blur-sm">
        <div className="container mx-auto px-6 text-center text-gray-400">
          <p>
            &copy; 2025 Vinicius Rampazzo. Aplicação desenvolvida utilizando
...
const MobileProjectCarousel = ({
  ...
  return (
    <div
      className={`md:hidden transform transition-all duration-800 ${
        isVisible ? "translate-y-0 opacity-100" : "translate-y-12 opacity-0"
      }`}
    >
      {/* Carousel Container */}
